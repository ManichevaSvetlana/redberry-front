<template>
  <div class="h-screen md:flex">
    ...
    <div class="flex md:w-1/2 justify-center py-10 items-center bg-white">
      <Form class="bg-white" @submit="handleRegister" :validation-schema="schema">
        <h1 class="text-gray-800 font-bold text-2xl mb-3">Create a new Account</h1>
        <div class="flex items-center border-2 py-2 px-3 rounded-2xl">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400" viewBox="0 0 20 20" fill="currentColor">
            <path fill-rule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clip-rule="evenodd"></path>
          </svg>
          <Field class="pl-2 outline-none border-none" type="text" name="name" id="name" placeholder="Full Name"/>
        </div>
